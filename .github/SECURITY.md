...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/session-sentinel/security/advisories/new)
...
- This repository (`hyperpolymath/session-sentinel`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/session-sentinel/security/advisories)
...
When using Session Sentinel, we recommend:
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/session-sentinel/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/session-sentinel/discussions) |
...
*Thank you for helping keep Session Sentinel and its users safe.* 🛡️
